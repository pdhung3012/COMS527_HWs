...
fopInput='/Users/hungphan/git/COMS527/Augment1/'
fopSerialTime='/Users/hungphan/git/COMS527/Aug1-SerialTimeAnalysis/'
fopOutputAnalysis='/Users/hungphan/git/COMS527/Aug1-OutputAnalysis/'
...
for i in range(0,len(listFiles)):
    ...
    try:
        strCommand1 = 'clang  -fopenmp ' + listFiles[i] + ' -o ' + fopOutputAnalysis + fileNameI + '.o'
